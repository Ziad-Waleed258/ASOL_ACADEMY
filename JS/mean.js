...
// --- 1. تحديد العناصر والأزرار ---
const langToggleButtonAR = document.getElementById('lang-ar');
const langToggleButtonEN = document.getElementById('lang-en');
const elementsToTranslate = document.querySelectorAll('[data-key]');
const htmlTag = document.documentElement; // للوصول إلى <html>

// --- 2. دالة جلب اللغة وتطبيقها ---
...
langToggleButtonAR.addEventListener('click', () => {
    setLanguage('ar');
});

langToggleButtonEN.addEventListener('click', () => {
    setLanguage('en');
});
